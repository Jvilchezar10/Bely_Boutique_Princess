import 'package:bely_boutique/models/Product.dart';
...
class CustomExtraProducts extends StatelessWidget {
  ...
  List<Product> _photos(BuildContext context) {
    return [
      Product(
        id: 1,
        description: 'Bestido blanco',
        price: 100.20,
        name: 'Produto1..',
        tags: 'places/india_chennai_flower_market.png',
